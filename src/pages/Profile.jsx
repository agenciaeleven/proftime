...
import { User, Camera, Save, Loader2, Mail, Phone, MapPin, BookOpen, Award, Edit3, Check } from "lucide-react";
        ...
        <div className="space-y-5">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { key: "full_name", label: "Nome Completo", placeholder: "Seu nome completo", icon: User },
